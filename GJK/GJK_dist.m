function [dist, p1, p2] = GJK_dist(shape1, shape2, iterations, tol)
	% GJK Gilbert-Johnson-Keerthi distance calculation implementation.
	% Returns the minimum distance between two convex objects
	% as well as the nearest points p1 and p2.
	%
	%   Shi Shenglei, 2018
	%
...
% 		if (abs(last_dist - dist) < tol)
% 			if len == 1
% 				p1 = a1; p2 = a2;
% 			elseif len == 2
% 				[p1, p2] = extractObjectPointsFromSegment(a, b, a1, b1, a2, b2, closest_p);
% 			elseif len == 3
% 				[p1, p2] = extractObjectPointsFromTriangle(a, b, c, a1, b1, c1, a2, b2, c2, closest_p);
% 			end
% 			break;
% 		end
		...
		if (len == 1)
			b = last; b1 = last1; b2 = last2;
		elseif (len == 2)
			c = last; c1 = last1; c2 = last2;
		elseif (len == 3)
			d = last; d1 = last1; d2 = last2;
		end
		len = len + 1;
	end
